...
// Thông tin sản phẩm
$product_weight = 1000; // Trọng lượng sản phẩm (đơn vị: gram)
$product_value = 500000; // Giá trị sản phẩm (đơn vị: VNĐ)

// Thông tin khách hàng
$customer_district_id = 750; // Mã số quận/huyện của khách hàng

// Thông tin API GHN
$ghn_api_token = '5c9b26f9-fcbb-11ed-82fc-92443ce24152';
$ghn_api_url = 'https://dev-online-gateway.ghn.vn/shiip/public-api/v2/shipping-order/fee';

// Thôngtin API Woocommerce
$wc_api_url = 'http://mywordpress.vn/wp-json/wc/v3/';
$wc_api_secret = 'cs_dbd4fdacb153dd496a1767f8d076711e58adf370';
$wc_api_key = 'ck_baaa77264d37f5970242c7f8c38190d5d486fc6d';

// Tính phí dịch vụ
$curl = curl_init();
curl_setopt_array($curl, array(
  CURLOPT_URL => "$ghn_api_url?token=$ghn_api_token&weight=$product_weight&to_district_id=$customer_district_id&service_type_id=2&coupon_code=&insurance_value=$product_value",
...
if ($err) {
  ...
  if ($response['code'] == 200) {
    ...
    // Hiển thị phí vận chuyển cho khách hàng
    echo "Phí vận chuyển: " . number_format($fee) . " VNĐ";
  }
}
