...
<body>
  ...
  <div class="header">
    <div class="logo">
      <a href="<?php bloginfo('url'); ?>"><img src="<?php bloginfo('template_directory'); ?>/images/logo.png" alt="<?php bloginfo('name'); ?>" class="img-logo" /></a>
    </div>
    <!-- <ul class="menu__list">
    ...
    <div class="right-header">
      <div class="icons-list">
        <div class="avatar-user_wrapper">
          <a href="<?php bloginfo('url'); ?>/tai-khoan" class="icon-header icon-user">
            <?php if (is_user_logged_in()) : ?>
              <!-- Hiển thị avatar của người dùng -->
              <div class="avatar-user"><?php echo get_avatar(get_current_user_id(), 32); ?></div>
              <div class="triangle"></div>
              <ul class="user-functions">
                <a href="<?php bloginfo('url'); ?>/tai-khoan">
                  <li>Tài khoản</li>
                </a>
        ...
        <a href="<?php bloginfo('url'); ?>/yeu-thich" class=" icon-header icon-heart">
          <svg width="22" height="20" viewBox="0 0 22 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M11 4.36803L10.1041 3.49488C7.99863 1.44301 4.14268 2.15131 2.75045 4.72927C2.09567 5.9417 1.94844 7.69178 3.14286 9.92599C4.29322 12.0778 6.68459 14.6536 11 17.4602C15.3154 14.6536 17.7068 12.0778 18.8571 9.92599C20.0516 7.69178 19.9043 5.9417 19.2496 4.72927C17.8573 2.15131 14.0014 1.44301 11.8959 3.49488L11 4.36803ZM11 18.8889C-8.16641 6.88105 5.09845 -2.49291 10.7804 2.46585C10.8549 2.5309 10.9282 2.59841 11 2.66842C11.0718 2.59842 11.1451 2.5309 11.2196 2.46586C16.9015 -2.49292 30.1664 6.88104 11 18.8889Z" fill="#212121" stroke="#212121" stroke-width="0.3" />
          </svg>
        </a>
        <div class="icon-bag_wrapper">
          <a href="<?php bloginfo('url'); ?>/gio-hang" class="icon-header icon-bag">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M3.9 5.73333L5.08557 14.275C5.22282 15.2638 6.06825 16 7.06658 16L17.8334 16C18.8317 16 19.6772 15.2638 19.8144 14.275L20.7632 7.43955C20.8883 6.53778 20.1878 5.73333 19.2774 5.73333L3.9 5.73333ZM3.9 5.73333L3.60486 3.4136C3.50205 2.60558 2.81454 2 2 2V2" stroke="#121219" stroke-width="1.5" />
