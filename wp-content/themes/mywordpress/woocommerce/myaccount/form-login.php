...
<div class="u-columns col2-set" id="customer_login">
  ...
  <div class="u-column1 col-1">
    ...
    <?php endif; ?>
    <div class="title_woocommerce_account_form">
      <div class="logo">
      ...
      <p style="margin-top: 15px;">Vui lòng nhập địa chỉ email và mật khẩu của bạn</p>
    </div>
    ...
    <form class="woocommerce-form woocommerce-form-login login" method="post">
      ...
      <p class="form-row woocommerce-form__account">
