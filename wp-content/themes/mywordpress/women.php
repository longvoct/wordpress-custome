...
<div class="women-content body-content margin-head">
  <div>
    <h3 class="block__title" style="text-align: left; margin-bottom: 15px;" data-aos="fade-right"
      data-aos-duration="500">Converse - Sự lựa chọn hoàn hảo cho những
      người phụ nữ táo bạo, tự tin</h3>
    <span class="block__text" data-aos="fade-right" data-aos-duration="500">Converse là biểu tượng của sự độc đáo và
      sáng tạo, giúp bạn thể hiện phong cách của mình
