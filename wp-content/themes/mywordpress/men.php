...
<div class="body-content margin-head">
  ...
  if ($products) {
    echo '<ul class="featured-products-list" data-aos="fade-up"
...
<div class="men-content body-content" style="margin-top: 80px;">
  <div class="block">
    <h3 class="block__title">Converse - Phong cách đích thực cho người đàn
      ông hiện đại</h3>
    <span class="block__text">Bạn là một người đàn ông mạnh mẽ và đang tìm
      kiếm một đôi giày phù hợp với phong cách của
