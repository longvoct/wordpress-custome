...
<div id="frame-thanhtoan">
  <div class="mc-loinhan">
    ...
    <div class="field-ghi-chu">
      ...
      <span class="nutcopy" id="copy_ghi_chu" style="margin: 10px 0;"><img alt="Copy nội dung ghi chú"
  ...
  <a target="blank" href="<?php echo $link_momo_mobile ?>" id="openappbtn" class="button alt nut-animation"><img
      src="<?php echo $this->icon; ?>" /> Mở App Momo <br> <span>thanh toán đơn #<?php echo $order_id ?></span></a>

  <?php $this->template_ifinish(); ?>

  <p>Hoặc bạn cũng có thể tải QR để quét và thanh toán qua app</p>
  <div class="qr-wrapper">
    <a download="qrcode" href="<?php echo $qr_url; ?>" target="_blank" id="downloadqrcode"
      class="btn-download-in-image">
...
<?php
    ...
    ?>
<div id="frame-thanhtoan" style="border: solid 1px #b02473;">
  ...
  <h3 style="margin-top: 20px;"><img style="width: 60px; height: 60px; object-fit: cover;"
      src="<?php echo $this->icon; ?>" /></h3>
  <div class="mc-loinhan" style="background: #b02473;
  color: #fff;">
    Người nhận: <strong><?php echo $this->fullname; ?></strong><br>
    Số điện thoại: <strong><?php echo $this->phone; ?></strong><br>
    Số tiền: <strong><?php echo $order->get_formatted_order_total() ?></strong> <br>
    Ghi chú chuyển tiền bạn ghi mã đơn hàng: <strong style="color:#ffffff"><?php echo $order_id; ?></strong>
  </div>
  <?php $this->template_ifinish(); ?>
