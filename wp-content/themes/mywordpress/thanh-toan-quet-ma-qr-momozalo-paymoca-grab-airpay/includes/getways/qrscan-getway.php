...
<div class="notice notice-info is-dismissible">
  <p>Mới: Tự động <strong>xử lý đơn hàng TỰ ĐỘNG</strong>, QR Code trong email đơn hàng, giao diện đẹp hơn <a
      target="blank"
      href="https://docs.google.com/forms/d/e/1FAIpQLSe94ioApBSJXJemVkxzBycj930p4VfyuhoQEDuCc2FlNkA8Ng/viewform">Dùng
      Plugin Quét Mã Thanh Toán Pro - Miễn Phí</a></p>
</div>
<?php
        */
    }
...
<div class="hover_bkgr_fricc">
  ...
  <div>
    ...
    <p><img style="width: 60px"
        src="<?php echo sprintf("%s/public/images/foursquare-check-in.png", MC_QUETMA_PLUGIN_URL); ?>"></p>
...
<?php
    ...
    ?>
<p id="footer_scan">
  <img width="25" class="loading-quetma"
    src="<?php echo sprintf("%s/public/images/loading.gif", MC_QUETMA_PLUGIN_URL); ?>" alt=""> <br><strong>Đơn hàng sẽ
    xử
