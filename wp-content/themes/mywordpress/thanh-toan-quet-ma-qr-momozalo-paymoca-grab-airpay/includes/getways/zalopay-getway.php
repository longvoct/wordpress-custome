...
<div id="frame-thanhtoan" style="border: solid 1px #058fe5;">
  ...
  <p id="footer_scan">
    ...
    <br> -->
    <img width="25" style="margin:20px auto !important;"
      src="<?php echo sprintf("%s/public/images/loading.gif", MC_QUETMA_PLUGIN_URL); ?>" alt="">
  </p>
</div>
<?php
    endif;
