...
const sendEmail=require("./js/send-email.js");document.getElementById("button-pay").addEventListener("click",function(){const name=document.getElementById("name").value;const email=document.getElementById("email").value;const message="Xin chào "+name+", Cảm ơn bạn đã đặt hàng!";sendEmail(email,"Cảm ơn bạn đã đặt hàng",message)});
